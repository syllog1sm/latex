...
Our segmentation evaluation excludes disfluent words.  When a disfluent word
begins a segment, we move its segment label back to the first fluent word.
   ...
   \end{tabular}
    \caption{\small Speech-repair disfluency detection precision, recall and
        F-measure on the development data.
         \label{tab:dfl}}
        %\textbf{Joint (S+D+P)}=Joint segmentation, disfluency detection
        ...
        %     on input with gold-standard segmentation.
%\vspace*{-4em}
\end{table}
