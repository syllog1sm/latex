...
The dynamic oracle training procedure introduces latent variables, as there are
often states where several trainsitions are zero-cost.  We therefore employ
the latent-variable structured averaged perceptron model described by \citet{sun:09}.
