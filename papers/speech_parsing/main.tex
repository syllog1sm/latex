...
We therefore compare our joint model to pipeline approaches, using two state-of-the-art
...
as much training data (as we require syntactic annotation).\footnote{
